...
-- Insert at least one admin for foreign key reference
INSERT INTO `admins` (`username`, `password`) VALUES
('admin', 'hashed_password_here');  -- Replace 'hashed_password_here' with actual hashed password
...
-- Insert events
INSERT INTO events (title, description, location, category, event_date, image_path, created_by) VALUES
